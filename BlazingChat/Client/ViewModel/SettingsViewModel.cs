...
namespace BlazingChat.ViewModels
{
    public class SettingsViewModel : ISettingsViewModel
    {
        ...
        {
            await _httpClient.GetFromJsonAsync<User>($"user/updatetheme?userId={10}&value={this.DarkTheme}");

            await _httpClient.GetFromJsonAsync<User>($"user/updatenotifications?userId={10}&value={this.Notifications}");
        }
